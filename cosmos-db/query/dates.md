---
title: Dates
description: Store, index, and query date and time objects as strings in Cosmos DB.
ms.date: 11/10/2025
---

# Dates - Query language in Cosmos DB (in Azure and Fabric)
