---
title: LASTINDEXOF
description: This function returns the starting position of the last occurrence of the second string expression within the first specified string expression, or -1 if the string isn't found.
ms.date: 11/10/2025
---
