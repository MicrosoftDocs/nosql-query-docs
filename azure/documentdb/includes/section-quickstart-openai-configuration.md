...
> [!NOTE]
> Not all models are available in all regions or with all deployment types. Check [Azure OpenAI model availability by region](https://learn.microsoft.com/azure/ai-services/openai/concepts/models#model-summary-table-and-region-availability) for supported combinations.
